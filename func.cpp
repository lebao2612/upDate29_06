...
void xemDiemSinhVien(string a, SVList& svlist) {
	...
	cout << left << setw(20) << "Ma MH" << setw(10) << "Diem GK" << setw(10) << "Diem CK" << setw(10) << "Diem Cong" << setw(10) << "GPA" << endl;
	while (i != NULL) {
		...
		while (!f.eof()) {
			...
			if (maso == a) {
				...
				getline(ss, cong, ',');
				getline(ss, gpa, '\n');
				cout << left << setw(20) << i->maMH << setw(10) << gk << setw(10) << ck << setw(10) << cong << setw(10) << gpa << endl;
				break;
			}
		}
		i = i->pnext;
	...
	while (temp1 != NULL) {
		...
		while (temp != NULL) {
			if (temp->MSSV == temp1->MSSV) {
				f << temp->No << "," << temp->MSSV << "," << temp->Ho << "," << temp->Ten << "," << temp->Gioitinh << "," << temp->Ngaysinh << "," << temp->ID << ",";
				Course* i = temp->data.Head;
				while (i != NULL) {
					if (i->maMH == a)
